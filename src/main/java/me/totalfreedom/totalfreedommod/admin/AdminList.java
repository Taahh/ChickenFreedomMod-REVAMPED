...
public class AdminList extends FreedomService
{
    ...
    public boolean isSuperAdmin(CommandSender sender)
    {
        Admin admin = getAdmin(sender);
        if (admin == null)
        {
        ...
        return admin.getRank().ordinal() >= Rank.SUPER_ADMIN.ordinal();
    }
    public boolean isExecutive(CommandSender sender)
    {
        Admin admin = getAdmin(sender);
        if (admin == null)
        {
        ...
        return admin.getRank().ordinal() >= Rank.EXECUTIVE.ordinal();
    }
    public boolean isTelnetClanAdmin(CommandSender sender)
    {
        Admin admin = getAdmin(sender);
        if (admin == null)
        {
        ...
        return admin.getRank().ordinal() >= Rank.TELNET_CLAN.ordinal();
    }
